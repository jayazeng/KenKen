...
public class Cell {
	...
	/* This will contain 0-n boolean values where 0 will be if the cell has an answer or not
	 * and 1-n will correspond to value and if they are applicable for the cell
	 * 
	 * BUT
	 * maybe instead we could use a stack instead?
	 */
